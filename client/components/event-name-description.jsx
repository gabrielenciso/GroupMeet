  ...
  render() {
    ...
    return (
      <div className='w-full px-11
                      lg:w-96 lg:order-1'>
        <input required placeholder="New Meeting Event" type="text" name="meetingName" value={nameVal} onChange={handleName}
        ...
        <textarea required placeholder="add description" name="meetingDescription" value={descVal} onChange={handleDescription}
